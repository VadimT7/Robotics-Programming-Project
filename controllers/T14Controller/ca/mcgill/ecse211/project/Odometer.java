...
public class Odometer implements Runnable {
  ...
  /** Prints odometer information to the console with x and y in tile lengths (feet). */
  public void printPositionInTileLengths() {
    lock.lock();
    System.out.println("Odometer:\tx =" + String.format("% 02.2f", x / TILE_SIZE)
        + "ft\ty =" + String.format("% 02.2f", y / TILE_SIZE)
        + "ft\ttheta =" + String.format("% 06.2f", theta) + " degrees"); 
    lock.unlock();
  }
